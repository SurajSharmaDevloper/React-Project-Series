...
import EndorsementListTable from '../../Tables/EndorsementListTable'
    ...
    return (
        <Card>
            <div className="text-xl font-semibold text-primary">
                <Bredcrumb heading="Endorsement List" page="endorsement_list" />
            </div>
            <div className='px-5'>
                <div className='flex p-5 w-full bg-light rounded-xl border border-neutral-300 gap-5 max-[750px]:flex-wrap justify-between items-baseline-last '>
            ...
            <div className='p-5'>
                <EndorsementListTable data={documentTableData} />
            </div>
        </Card>
    )
}
