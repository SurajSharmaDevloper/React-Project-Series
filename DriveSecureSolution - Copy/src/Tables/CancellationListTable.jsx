...
const CancellationListTable = ({ data = [] }) => {
    ...
    return (
        <div className="p-6 py-2 bg-[#fff9f9] rounded-xl font-[Poppins]">
            <div className="mb-6 mt-3 flex justify-center items-baseline-last sm:justify-between max-[650px]:flex-col">
                ...
                <Button className="flex justify-center text-sm"><NavLink to="/cancellation" className='flex items-center gap-1 '><Plus sizes={16} /> Add New Cancellation</NavLink></Button>
            </div>
...
export default CancellationListTable;
